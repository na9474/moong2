	...
	<div id="alarm-outer">
        ...
        <div id="teacher-detail">
                <table  style="margin: auto;" id="teacher-tb1">
                    <tr>
                        <td rowspan="6" style="width:150px; height: 200px; border: 1px solid black;" id="div-preview" ><div><img style="height:200px; width:150px;" src="${idPicture.ipSysName }"></div></td>
                        <td>이름 : </td>
